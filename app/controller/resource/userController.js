...
module.exports.updateRole = function (req, res) {
  ...
  if (!req.user.isAdmin) {
    ...
    userService
      .updateRole(req.body, req.params, req.user)
      .then(function (data) {
...
/**
 * Method that delete user [Administrator only]
 * @param {Object} req
 * @param {Object} res
 * @return {Promise}
 */
module.exports.deleteUser = function (req, res) {
  ...
  if (!req.user.isAdmin) {
    logger.info("[brokerController] deleteUser Not ADM");
    error.sendError(env.errCodes.ERR401, res);
  } else {
    userService
      .deleteUser(req.params, req.user)
      .then(function (data) {
...
/**
 * Method that activate user [Administrator only]
 * @param {Object} req
 * @param {Object} res
 * @return {Promise}
 */
